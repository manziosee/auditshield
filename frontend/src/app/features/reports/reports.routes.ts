...
export const REPORTS_ROUTES: Routes = [
  ...
  { path: 'scheduled', loadComponent: () => import('./scheduled-reports/scheduled-reports.component').then((m) => m.ScheduledReportsComponent), title: 'Scheduled Reports — AuditShield' },
];
