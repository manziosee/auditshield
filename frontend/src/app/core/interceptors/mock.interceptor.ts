...
const EMPLOYEES = [
  { id: 'emp-001', employee_number: 'EMP-001', full_name: 'Jean-Pierre Uwimana',    first_name: 'Jean-Pierre', last_name: 'Uwimana',
    email: 'jp.uwimana@rwandatrade.rw',        phone: '+250 788 100 001',
    gender: 'M', date_of_birth: '1985-03-15',  national_id: '1198500003157801', address: 'KG 7 Ave, Kigali Heights', photo: null,
    ...
    contract_end_date: null, probation_end_date: null,         gross_salary: '800000', currency: 'RWF',
    rssb_number: 'RSSB100001', tin_number: '100000001',        is_active: true, compliance_score: 95, created_at: '2022-01-15T00:00:00Z' },
  { id: 'emp-002', employee_number: 'EMP-002', full_name: 'Marie Mukamurenzi',      first_name: 'Marie', last_name: 'Mukamurenzi',
    email: 'marie.m@rwandatrade.rw',           phone: '+250 788 100 002',
    gender: 'F', date_of_birth: '1988-07-22',  national_id: '1198800003157802', address: 'KN 3 St, Kimihurura', photo: null,
    ...
    contract_end_date: null, probation_end_date: null,         gross_salary: '650000', currency: 'RWF',
    rssb_number: 'RSSB100002', tin_number: '100000002',        is_active: true, compliance_score: 92, created_at: '2022-03-01T00:00:00Z' },
  { id: 'emp-003', employee_number: 'EMP-003', full_name: 'Claude Habimana',        first_name: 'Claude', last_name: 'Habimana',
    email: 'claude.h@rwandatrade.rw',          phone: '+250 788 100 003',
    gender: 'M', date_of_birth: '1990-01-10',  national_id: '1199000003157803', address: 'KK 15 Ave, Gisozi', photo: null,
    ...
    contract_end_date: null, probation_end_date: null,         gross_salary: '580000', currency: 'RWF',
    rssb_number: 'RSSB100003', tin_number: '100000003',        is_active: true, compliance_score: 88, created_at: '2022-06-01T00:00:00Z' },
  { id: 'emp-004', employee_number: 'EMP-004', full_name: 'Espérance Uwera',        first_name: 'Espérance', last_name: 'Uwera',
    email: 'esp.uwera@rwandatrade.rw',         phone: '+250 788 100 004',
    gender: 'F', date_of_birth: '1995-05-30',  national_id: '1199500003157804', address: 'KN 7 Rd, Nyarutarama', photo: null,
    ...
    contract_end_date: '2027-01-14', probation_end_date: null, gross_salary: '520000', currency: 'RWF',
    rssb_number: 'RSSB100004', tin_number: '100000004',        is_active: true, compliance_score: 90, created_at: '2023-01-15T00:00:00Z' },
  { id: 'emp-005', employee_number: 'EMP-005', full_name: 'Patrick Nshimiyimana',   first_name: 'Patrick', last_name: 'Nshimiyimana',
    email: 'patrick.n@rwandatrade.rw',         phone: '+250 788 100 005',
    gender: 'M', date_of_birth: '1992-11-20',  national_id: '1199200003157805', address: 'KG 12 Ave, Kacyiru', photo: null,
    ...
    contract_end_date: null, probation_end_date: null,         gross_salary: '500000', currency: 'RWF',
    rssb_number: 'RSSB100005', tin_number: '100000005',        is_active: true, compliance_score: 85, created_at: '2023-04-01T00:00:00Z' },
  { id: 'emp-006', employee_number: 'EMP-006', full_name: 'Aline Iradukunda',       first_name: 'Aline', last_name: 'Iradukunda',
    email: 'aline.i@rwandatrade.rw',           phone: '+250 788 100 006',
    gender: 'F', date_of_birth: '1997-08-12',  national_id: '1199700003157806', address: 'KN 2 St, Remera', photo: null,
    ...
    contract_end_date: null, probation_end_date: null,         gross_salary: '380000', currency: 'RWF',
    rssb_number: 'RSSB100006', tin_number: '100000006',        is_active: true, compliance_score: 88, created_at: '2023-07-01T00:00:00Z' },
  { id: 'emp-007', employee_number: 'EMP-007', full_name: 'Félix Rugamba',          first_name: 'Félix', last_name: 'Rugamba',
    email: 'felix.r@rwandatrade.rw',           phone: '+250 788 100 007',
    gender: 'M', date_of_birth: '1999-02-28',  national_id: '1199900003157807', address: 'KK 3 Ave, Kicukiro', photo: null,
    ...
    contract_end_date: '2027-01-14', probation_end_date: '2026-04-14', gross_salary: '350000', currency: 'RWF',
    rssb_number: 'RSSB100007', tin_number: '100000007',        is_active: true, compliance_score: 70, created_at: '2026-01-15T00:00:00Z' },
];

const DOCUMENTS = [
  { id: 'doc-001', employee: null,      employee_name: '',                   uploaded_by_name: 'Demo Admin',
    title: 'PAYE Return March 2026',         document_type: 'paye_return',
    file: '/media/paye-march-2026.pdf',       file_name: 'paye-march-2026.pdf',      file_size: 245760,   mime_type: 'application/pdf',
    description: 'Monthly PAYE return for March 2026',      tags: ['rra','paye'],       status: 'active',
    expiry_date: '2026-12-31',  issue_date: '2026-03-01',   reference_number: 'RRA/PAYE/2026/03',
  ...
  { id: 'doc-002', employee: null,      employee_name: '',                   uploaded_by_name: 'Demo Admin',
    title: 'RSSB Declaration Q1 2026',       document_type: 'rssb_declaration',
    file: '/media/rssb-q1-2026.pdf',          file_name: 'rssb-q1-2026.pdf',        file_size: 184320,   mime_type: 'application/pdf',
    description: 'RSSB quarterly declaration Q1 2026',       tags: ['rssb','q1'],       status: 'active',
    expiry_date: '2026-03-20',  issue_date: '2026-01-10',   reference_number: 'RSSB/2026/Q1/001',
  ...
  { id: 'doc-003', employee: 'emp-001', employee_name: 'Jean-Pierre Uwimana', uploaded_by_name: 'Demo Admin',
    title: 'Employment Contract — J.P. Uwimana', document_type: 'employment_contract',
    ...
    expiry_date: null,          issue_date: '2022-01-15',   reference_number: 'RTS/EMP/2022/001',
  ...
  { id: 'doc-004', employee: null,      employee_name: '',                   uploaded_by_name: 'Demo Admin',
    ...
    description: 'RDB company registration certificate',      tags: ['rdb'],             status: 'active',
    expiry_date: '2027-06-30',  issue_date: '2022-01-01',   reference_number: 'RDB/COMP/2022/789456',
  ...
  { id: 'doc-006', employee: null,      employee_name: '',                   uploaded_by_name: 'Demo Admin',
    ...
    description: 'RRA tax clearance certificate',             tags: ['rra','clearance'],  status: 'active',
    expiry_date: '2026-03-10',  issue_date: '2026-01-10',   reference_number: 'RRA/TC/2026/001',
  ...
  { id: 'doc-007', employee: null,      employee_name: '',                   uploaded_by_name: 'Demo Admin',
    ...
    description: 'Monthly VAT return February 2026',          tags: ['rra','vat'],       status: 'active',
    expiry_date: null,          issue_date: '2026-02-20',   reference_number: 'RRA/VAT/2026/02',
  ...
  { id: 'doc-008', employee: 'emp-002', employee_name: 'Marie Mukamurenzi',   uploaded_by_name: 'Demo Admin',
    title: 'Employment Contract — M. Mukamurenzi', document_type: 'employment_contract',
    ...
    expiry_date: null,          issue_date: '2022-03-01',   reference_number: 'RTS/EMP/2022/002',
...
const COMPLIANCE_RECORDS = [
  { id: 'crec-001', requirement: 'req-001', requirement_title: 'PAYE Monthly Filing',       requirement_frequency: 'monthly',   category_name: 'Tax Compliance',        authority: 'RRA',
    status: 'compliant', period_start: '2026-01-01', period_end: '2026-01-31', due_date: '2026-02-15', completed_date: '2026-02-10', notes: 'Filed via RRA e-tax portal.', is_overdue: false, created_at: '2026-02-10T10:00:00Z' },
  { id: 'crec-002', requirement: 'req-002', requirement_title: 'RSSB Monthly Contributions', requirement_frequency: 'monthly',   category_name: 'Social Security',       authority: 'RSSB',
  ...
  { id: 'crec-003', requirement: 'req-003', requirement_title: 'VAT Return Filing',          requirement_frequency: 'monthly',   category_name: 'Tax Compliance',        authority: 'RRA',
  ...
  { id: 'crec-004', requirement: 'req-004', requirement_title: 'Business License Renewal',   requirement_frequency: 'annually',  category_name: 'Business Registration', authority: 'RDB',
  ...
  { id: 'crec-005', requirement: 'req-005', requirement_title: 'RSSB Q4 2025 Declaration',   requirement_frequency: 'quarterly', category_name: 'Social Security',       authority: 'RSSB',
  ...
  { id: 'crec-006', requirement: 'req-006', requirement_title: 'Annual Labour Compliance Audit', requirement_frequency: 'annually', category_name: 'Labour Law',           authority: 'Labour',
  ...
  { id: 'crec-007', requirement: 'req-007', requirement_title: 'Annual Income Tax Return',    requirement_frequency: 'annually',  category_name: 'Tax Compliance',        authority: 'RRA',
  ...
  { id: 'crec-008', requirement: 'req-008', requirement_title: 'PAYE February 2026 Filing',   requirement_frequency: 'monthly',   category_name: 'Tax Compliance',        authority: 'RRA',
...
const NOTIFICATIONS = [
  { id: 'notif-001', notification_type: 'document_expiry', title: 'Tax Clearance Certificate expiring soon', body: 'Your Tax Clearance Certificate (RRA/TC/2026/001) expires in 13 days on March 10, 2026. Please renew before the deadline.', is_read: false, is_sent_email: true, related_object_id: 'doc-006', related_object_type: 'document', created_at: '2026-02-25T08:00:00Z' },
  { id: 'notif-002', notification_type: 'compliance_due',  title: 'VAT Return filing due in 18 days',         body: 'VAT Return for February 2026 is due on March 15, 2026. Please complete the filing to avoid RRA penalties.', is_read: false, is_sent_email: true, related_object_id: 'crec-003', related_object_type: 'compliance_record', created_at: '2026-02-24T08:00:00Z' },
  { id: 'notif-003', notification_type: 'document_expiry', title: 'RSSB Declaration expires in 23 days',      body: 'RSSB Declaration Q1 2026 (RSSB/2026/Q1/001) will expire on March 20, 2026.', is_read: false, is_sent_email: false, related_object_id: 'doc-002', related_object_type: 'document', created_at: '2026-02-23T08:00:00Z' },
  { id: 'notif-004', notification_type: 'compliance_due',  title: 'RSSB Q4 2025 declaration is overdue',     body: 'RSSB Q4 2025 Declaration was due on January 31 and has not been submitted. File immediately to avoid fines.', is_read: true,  is_sent_email: true, related_object_id: 'crec-005', related_object_type: 'compliance_record', created_at: '2026-02-01T09:00:00Z' },
  ...
  { id: 'notif-006', notification_type: 'system',          title: 'New employee added to system',              body: 'Félix Rugamba (EMP-007) has been added as Sales Representative and is currently in probation.', is_read: true, is_sent_email: false, related_object_id: 'emp-007', related_object_type: 'employee', created_at: '2026-01-15T08:05:00Z' },
];
...
const REPORTS = [
  ...
  { id: 'rep-003', title: 'PAYE Filing March 2026',           report_type: 'rra_filing',       generated_by: U_ID, generated_by_name: 'Demo Admin', period_start: '2026-03-01', period_end: '2026-03-31', is_ready: false, parameters: {}, created_at: '2026-02-25T09:30:00Z' },
];

const MOCK_COMPANY = {
  id: CO_ID, name: 'Rwanda Trade Solutions Ltd',
  registration_number: 'RDB/COMP/2022/789456', tin_number: '100123456', rssb_number: 'RSSB/ER/2022/001',
  industry: 'retail', phone: '+250 788 200 000', email: 'info@rwandatrade.rw',
  website: 'https://rwandatrade.rw', address: 'KG 7 Ave, Kigali Heights, 6th Floor',
  city: 'Kigali', country: 'Rwanda', logo: null, fiscal_year_start: 1, employee_count: 7,
};
...
export const mockInterceptor: HttpInterceptorFn = (req, next) => {
  ...
  if (path.match(/^documents\/[^/]+\/preview_text\/$/) && method === 'GET') return ok({ extracted_text: 'RWANDA TRADE SOLUTIONS LTD\nKG 7 Ave, Kigali Heights\nTIN: 100123456\n\nPAYE RETURN — MARCH 2026\n\nTotal Gross Salary:   RWF 3,780,000\nTotal PAYE Deducted:  RWF   542,400\nNet Payable:          RWF 3,237,600\n\nFiled via RRA e-Tax portal on 05 March 2026.', ocr_processed: true });
